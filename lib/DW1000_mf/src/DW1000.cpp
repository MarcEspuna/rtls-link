...
byte DW1000Class::_pulseFrequency = TX_PULSE_FREQ_64MHZ;
byte DW1000Class::_dataRate = TRX_RATE_6800KBPS;
byte DW1000Class::_preambleLength = TX_PREAMBLE_LEN_128;
byte DW1000Class::_preambleCode = PREAMBLE_CODE_64MHZ_9;
...
// SPI settings
    ...
    // Set your desired frequency for ESP32S3 here
    const SPISettings DW1000Class::_fastSPI = SPISettings(20000000L, MSBFIRST, SPI_MODE0);
	const SPISettings DW1000Class::_slowSPI = SPISettings(1400000L, MSBFIRST, SPI_MODE0);
#else
...
void DW1000Class::setDefaults()
{
	...
	else if (_deviceMode == IDLE_MODE)
	{
		...
		*/
		...
		enableMode(MODE_SHORTDATA_FAST_ACCURACY);
