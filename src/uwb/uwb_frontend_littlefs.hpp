...
public:
    static constexpr ParamDef s_ParamDefs[] = {
        ...
        PARAM_DEF(UWBParams, apOutputMode),
        PARAM_DEF(UWBParams, apBeaconPositionMode),
        PARAM_DEF(UWBParams, apBeaconPositionStartupMs),
        PARAM_DEF(UWBParams, apBeaconPositionErrorMm),
