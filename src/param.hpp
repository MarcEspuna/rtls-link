...
using apoutputmode_type = etl::type_id_pair<APOutputMode, static_cast<size_t>(ParamType::ENUM)>;
using apbeaconpositionmode_type = etl::type_id_pair<APBeaconPositionMode, static_cast<size_t>(ParamType::ENUM)>;
...
using TypeIdLookup = etl::type_id_lookup<
                        ...
                        apoutputmode_type, apbeaconpositionmode_type>;
