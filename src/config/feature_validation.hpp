...
#if defined(USE_UWB_MODE_TWR_TAG) && !defined(USE_MAVLINK) && !defined(USE_RTLSLINK_BEACON_BACKEND)
    #error "USE_UWB_MODE_TWR_TAG requires either USE_MAVLINK or USE_RTLSLINK_BEACON_BACKEND for position output"
#endif
